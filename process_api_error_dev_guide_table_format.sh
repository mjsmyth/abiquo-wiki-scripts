...
# 
# ./process_api_error_dev_guide_table_format.sh input_files/APIError.java.txt output_files/wiki_api_error_dev_guide_table_format.txt
# 
...
END {
   print "|| Internal Message ID {color:#efefef}__________________{color}|| Message {color:#efefef}____________________________________________________________{color} || Label {color:#efefef}__________________{color} || Info ||"; 
   for (s=1; s<=NR; s++) 
