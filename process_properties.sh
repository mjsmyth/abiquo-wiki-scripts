...
# wiki_properties.txt - wiki storage format for pasting in the Abiquo Configuration Properties page
...
# Field separator is new line
  ...
  print "<th class=\"warning\" data-highlight-class=\"warning\"><p>Default</p></th>" >> "output_files/wiki_properties.txt";
  print "<th class=\"warning\" data-highlight-class=\"warning\"><p>Range</p></th>" >> "output_files/wiki_properties.txt";
  print "<th class=\"warning\" data-highlight-class=\"warning\"><p>Description</p></th>" >> "output_files/wiki_properties.txt";
  print "<th class=\"warning\" colspan=\"1\" data-highlight-class=\"warning\">" linkAPIA linkAPIB "</th>" >> "output_files/wiki_properties.txt";
  print "<th class=\"warning\" colspan=\"1\" data-highlight-class=\"warning\">" linkRSA linkRSB "</th>" >> "output_files/wiki_properties.txt";
  print "<th class=\"warning\" colspan=\"1\" data-highlight-class=\"warning\">" linkV2VA linkV2VB "</th>" >> "output_files/wiki_properties.txt";
  print "<th class=\"warning\" colspan=\"1\" data-highlight-class=\"warning\">" linkOAA linkOAB "</th>" >> "output_files/wiki_properties.txt";
...
END{
 ...
 #              }
          ...
          print outputLine[myLine] >> "output_files/wiki_properties.txt";     
      }
    print "</tbody>\n</table>" >> "output_files/wiki_properties.txt";
}' >$2 
