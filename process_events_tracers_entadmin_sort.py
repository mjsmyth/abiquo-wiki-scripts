...
def main():
	...
	td = "2016-02-22"
	wiki_event_tracer_all_file = "wiki_event_tracer_ent_admin_" + td + ".txt"
	git_dir = "../platform/m/src/main/resources/messages"
	input_subdir = "input_files"
	input_date = "2016-02-22"
	entity_file = "entity_list_ent_admin_" + input_date + ".txt"
	prop_file = "tracer.properties"
	entity_action_file = "entity_action_list_ent_admin_" + input_date + ".txt"
